...
static int re_match_2_internal (struct re_pattern_buffer *bufp, const char *string1, int size1, const char *string2,
...
static int bcmp_translate (const unsigned char *s1, const unsigned char *s2, register int len, RE_TRANSLATE_TYPE translate);
