...
*/
#ifndef SQLITECONNECTIONINFORMATION__H
#define SQLITECONNECTIONINFORMATION__H

class CSQLiteConnectionInformation : public CSqlConnectionInformation
{
	friend class CSQLiteConnection;
public:
	CSQLiteConnectionInformation() { }
	virtual ~CSQLiteConnectionInformation() { }
