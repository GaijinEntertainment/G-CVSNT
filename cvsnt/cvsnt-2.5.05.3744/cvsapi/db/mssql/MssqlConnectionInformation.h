...
*/
#ifndef MSSQLCONNECTIONINFORMATION__H
#define MSSQLCONNECTIONINFORMATION__H

class CMssqlConnectionInformation : public CSqlConnectionInformation
{
	friend class CMssqlConnection;
public:
	CMssqlConnectionInformation() { }
	virtual ~CMssqlConnectionInformation() { }
