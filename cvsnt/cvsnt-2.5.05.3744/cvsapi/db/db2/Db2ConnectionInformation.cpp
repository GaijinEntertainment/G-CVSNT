...
const char *CDb2ConnectionInformation::getVariable(const char *name)
{
...
bool CDb2ConnectionInformation::setVariable(const char *name, const char *value)
{
...
const char *CDb2ConnectionInformation::enumVariableNames(size_t nVar)
{
	switch(nVar)
	{
...
#ifndef _WIN32
bool CDb2ConnectionInformation::connectionDialog(const void *parentWindow)
{
	return false;
}
#else
...
BOOL CALLBACK CDb2ConnectionInformation::ConnectionDialogProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	{
		case WM_INITDIALOG:
			pCI = (CDb2ConnectionInformation*)lParam;
