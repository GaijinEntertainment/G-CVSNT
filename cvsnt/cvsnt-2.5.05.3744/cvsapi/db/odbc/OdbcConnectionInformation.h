...
*/
#ifndef ODBCCONNECTIONINFORMATION__H
#define ODBCCONNECTIONINFORMATION__H

class COdbcConnectionInformation : public CSqlConnectionInformation
{
	friend class COdbcConnection;
public:
	COdbcConnectionInformation() { }
	virtual ~COdbcConnectionInformation() { }
