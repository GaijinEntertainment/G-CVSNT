...
*/
#ifndef ORACLECONNECTIONINFORMATION__H
#define ORACLECONNECTIONINFORMATION__H

class COracleConnectionInformation : public CSqlConnectionInformation
{
	friend class COracleConnection;
public:
	COracleConnectionInformation() { }
	virtual ~COracleConnectionInformation() { }
...
protected:
	cvs::string schema,tablespace,home,nls_nchar,nls_lang;
