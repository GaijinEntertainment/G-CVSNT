...
const char *CMySqlConnectionInformation::getVariable(const char *name)
{
...
bool CMySqlConnectionInformation::setVariable(const char *name, const char *value)
{
...
const char *CMySqlConnectionInformation::enumVariableNames(size_t nVar)
{
	switch(nVar)
	{
...
#ifndef _WIN32
bool CMySqlConnectionInformation::connectionDialog(const void *parentWindow)
{
	return false;
}
#else
...
BOOL CALLBACK CMySqlConnectionInformation::ConnectionDialogProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	{
		case WM_INITDIALOG:
			pCI = (CMySqlConnectionInformation*)lParam;
