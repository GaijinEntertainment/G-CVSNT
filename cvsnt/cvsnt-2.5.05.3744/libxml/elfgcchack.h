...
#ifdef bottom_xmlmemory
#undef xmlHPUXFree
extern __typeof (xmlHPUXFree) xmlHPUXFree __attribute((alias("xmlHPUXFree__internal_alias")));
#else
#ifndef xmlHPUXFree
extern __typeof (xmlHPUXFree) xmlHPUXFree__internal_alias __attribute((visibility("hidden")));
#define xmlHPUXFree xmlHPUXFree__internal_alias
#endif
#endif
#endif
